...
export default function EventsSection({ initiatives = [] }: { initiatives?: InitiativeCard[] }) {
  ...
  return (
    <section className="py-12 sm:py-16 space-y-10 sm:space-y-12">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-6">
        ...
        <Link href="/events" className="w-full sm:w-auto flex-shrink-0" prefetch>
          <Button variant="outline" className="w-full sm:w-auto font-semibold gap-2 cursor-pointer">
      ...
      {cards.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-primary/20 bg-card/60 p-8 sm:p-10 text-center text-sm text-muted-foreground">
          ...
          {cards.map((initiative, index) => (
            ...
            >
              <div className="relative aspect-[16/9] w-full overflow-hidden">
                ...
                />
                <span className="absolute top-3 left-3 text-[10px] font-extrabold bg-primary text-primary-foreground uppercase px-2.5 py-1 rounded-full shadow">
              ...
              <div className="p-5 sm:p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 text-xs text-muted-foreground font-medium">
