  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      <PublicHero 
        ...
        description={`Explore the chronological archive of campaigns, citations, and flagship projects completed by ${appName} delegates over the years.`}
      />
      <PublicSection background="white">
        <div className="space-y-12 sm:space-y-16 max-w-4xl mx-auto mt-8">
            ...
            {HISTORICAL_MILESTONES.map((milestone, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="hidden md:flex absolute right-full mr-10 top-1.5 text-xl lg:text-2xl font-black text-slate-900 select-none whitespace-nowrap">
                    {milestone.year}
                  </span>
                  ...
                  <span className="flex md:hidden text-base font-black text-slate-900 mb-1.5">
                    {milestone.year}
                  </span>
