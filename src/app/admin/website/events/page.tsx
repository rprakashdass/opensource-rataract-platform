    ...
    <div className="w-full h-full px-4 md:px-8 py-6 flex flex-col">
      <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-4 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Events Page Editor</h1>
            <p className="text-slate-500 mt-0.5 text-sm">Manage the copy shown on the public Events page.</p>
          </div>
        </div>
      </div>
