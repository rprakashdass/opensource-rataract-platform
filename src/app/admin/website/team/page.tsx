...
import TeamEditorForm from "./_components/TeamEditorForm";
...
export default async function TeamEditorPage() {
  ...
  return (
    <div className="w-full h-full px-4 md:px-8 py-6 flex flex-col">
      <PageHeader
        title="Team Page Editor"
        description="Manage the copy shown on the public Team page."
      ...
      <div className="flex-1 min-h-0">
        <TeamEditorForm settings={settings} />
      </div>
    </div>
  );
}
