...
export default function EventMemories({ eventId, eventTitle }: { eventId: string; eventTitle: string }) {
    ...
    <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm mt-6">
      ...
      <div className="space-y-4">
        <p className="text-sm text-slate-500">
          Share your photos from the event! The organizing team may feature some of them on the club website.
        </p>
